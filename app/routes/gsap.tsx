...
const Page = () => {
    ...
    () => {
      ...
      let tl = gsap.timeline({
        scrollTrigger: {
          ...
          anticipatePin: 1,
          snap: {
            snapTo: [0, 1.4 / 5, 2.4 / 5, 3.4 / 5, 4.2 / 5, 1],
      ...
      tl.fromTo(
        ".island",
        { opacity: 0, scale: 0 },
        { opacity: 1, scale: 5, duration: 2.5, ease: "power1.out" },
        1
      );
  ...
  return (
    ...
    >
      ...
      {/* Section 6*/}
      <div
        className={`five h-screen flex flex-col justify-between items-center absolute inset-0`}
      >
        <Applications />
        <footer
